...
(function(){
  'use strict';
  khorzuRun.$inject = ["$rootScope", "authManager", "storage"];
  khorzConfig.$inject = ["$httpProvider", "jwtOptionsProvider"];
  khorzuService.$inject = ["$rootScope", "$state", "$q", "$timeout", "$http", "$mdToast", "$mdDialog", "jwtHelper"];
  var khorzu = {
    configs:{
